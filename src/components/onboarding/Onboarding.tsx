...
export function Onboarding() {
  ...
  if (step === 2) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-8 text-center">
        ...
        <Button onClick={() => setStep(3)} className="w-full max-w-xs h-12 text-base">
          Continue
        </Button>
      </div>
    );
  ...
  if (step === 3) {
    return (
      <div className="min-h-screen bg-background flex flex-col px-8 pt-16">
        ...
        <Button
          onClick={() => { setDecoySkin(selectedSkin); setStep(4); }}
  ...
  // Step 4: How to Access (dynamic instructions)
  if (step === 4) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-8 text-center">
        ...
        <h1 className="text-xl font-semibold text-foreground mb-4">How to access your safe space</h1>
        <p className="text-muted-foreground leading-relaxed mb-4">
          To open the real interface from the disguise app:
        </p>
        <p className="text-lg font-medium text-primary mb-12">
          {accessInstructions[selectedSkin]}
        </p>
        <Button onClick={() => setStep(5)} className="w-full max-w-xs h-12 text-base">
          Got it
        </Button>
      </div>
    );
  ...
  // Step 5: Complete onboarding, enter real UI
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-8 text-center">
      <Shield className="w-16 h-16 text-primary mb-8" />
      <h1 className="text-2xl font-semibold text-foreground mb-4">You're all set.</h1>
      <p className="text-muted-foreground leading-relaxed mb-12">
        You'll now enter your safe space for the first time. Remember, you can always exit quickly.
      </p>
      <Button
        onClick={() => { completeOnboarding(); enterRealMode(); }}
